...
const List<MenuItem> operatorMenuItems = [
  ...
  MenuItem(label: 'Profil Saya', icon: Icons.person_outline, activeIcon: Icons.person, index: 6),
];

// SuperAdmin menu
const List<MenuItem> superAdminMenuItems = [
  MenuItem(label: 'Dashboard', icon: Icons.dashboard_outlined, activeIcon: Icons.dashboard, index: 0),
  MenuItem(label: 'Kelola Seminar', icon: Icons.book_outlined, activeIcon: Icons.book, index: 1),
  MenuItem(label: 'Kelola Artikel', icon: Icons.newspaper_outlined, activeIcon: Icons.newspaper, index: 2),
  MenuItem(label: 'Kelola Panduan', icon: Icons.menu_book_outlined, activeIcon: Icons.menu_book, index: 3),
  MenuItem(label: 'Kelola Regulasi', icon: Icons.gavel_outlined, activeIcon: Icons.gavel, index: 4),
  MenuItem(label: 'Gallery', icon: Icons.photo_library_outlined, activeIcon: Icons.photo_library, index: 5),
  MenuItem(label: 'Akun Operator', icon: Icons.people_outline, activeIcon: Icons.people, index: 6),
  MenuItem(label: 'Pengaturan', icon: Icons.settings_outlined, activeIcon: Icons.settings, index: 7),
];
...
class AdminDrawer extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final menuItems = isSuper ? superAdminMenuItems : operatorMenuItems;
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          (user?.role ?? 'operator').replaceFirst(
